...
class TethysBase {
	...
	public:
		...
		*/
        ...
        /********/
        DataSpace* Dataspacecycfrq; //dataspace for cyclotron anisotropy
        DataSpace* DataspacecycfrqMid; //dataspace for cyclotron anisotropy

        DataSpace* Dataspaceoddvis; //dataspace for cyclotron anisotropy
        DataSpace* DataspaceoddvisMid; //dataspace for cyclotron anisotropy

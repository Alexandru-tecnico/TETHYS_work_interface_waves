...
class Fluid2D : public TethysBase
{
	protected:
        ...
        /*********************/
        float * cycl_arr; //array for saving Wc(x,y) potentially for main grid
        float * cycl_arr_mid;//array for saving Wc(x,y) potentially for aux grid

        float *oddvisco_arr; // same thing but for odd viscosity
        float *oddvisco_arr_mid;
...
public :
        ...
        void SetCycl(); //Applies anisotropy of cyclotronic frequency-changed

        void SetOdd(); //Applies anisotropy in odd viscosity
		...
		virtual float XMomentumSource(float n, float flx_x, float flx_y, float mass, float s,GridPoint p, int k); ///< velocity X component equation (momentum equation) source term
		virtual float YMomentumSource(float n, float flx_x, float flx_y, float mass, float s, GridPoint p, int k); ///< velocity y component equation (momentum equation) source term
        ...
        // UNGATED-NOT HERE -- on Graphene Only!!
        //virtual float XMomentumFluxX_ung(GridPoint p, char side ); ///< velocity X component equation (momentum equation) conserved flux X component
        //----------
        ...
        //UNGATED--NOT HERE!!
       // virtual float YMomentumFluxY_ung(GridPoint p, char side ); ///< velocity Y component equation (momentum equation) conserved flux Y component
        //---------
		...
		* */
        ...
        /***************/
        void SaveCycl(); ///< Records a mesh of eventual cyclotron frequency anisotropy at the HDF5 file

        void SaveOdd(); // Same as above for odd visco
        /****************/
